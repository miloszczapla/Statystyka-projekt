source("Przygotowanie_Ramki_Danych.R", encoding = "UTF-8")
...
wykres2
#Wykres 2 - Zarobki, ale ty juz to zrobiles, mozna zostawic jako 2 osobne, ale nie wiem czy jest sens, 
#jak cos to usun, bo to w zasadzie to samo co na twoim 1 wykresie tyle, ze slupkowe
